...
<?php
 ...
 function fun3()//Projekt
 {
        exec("php posun.php");
        exec("php Po.php");
        header("Location:PDP.php");
 }
 function fun4()//Chcem nakupit Novy
 {
        exec("php posun.php");
        exec("php ChN.php");
  ...
  height: 20%;
   ...
   <body style="text-align:center;">
		<div  class="Hlavicka" >
                ...
                <div class="box">
                        <div class="login">
                                <button id="btnfun1" name="tlc" onClick='location.href="?button1=1"'>Mám dohodnutý termín</button>
                                <button id="btnfun2" name="tlc" onClick='location.href="?button2=1"'>Poradenstvo s výberom svetiel do domu či bytu</button>
                        </div>
                        <div class="login">
                                <button id="btnfun3" name="tlc" onClick='location.href="?button3=1"'>Poradenstvo: osvetlenie skladu,výroby, kancelárie, pouličné...</button>
