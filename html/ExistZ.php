...
<?php
 ...
 if($_GET['button4']){fun4();}
  function fun1()//velkoobchod
 {
        exec("php posun.php");
        exec("php Vo.php");
        header("Location:PDP.php");
 }
 function fun2()//chcem nakup
 {
        exec("php posun.php");
        exec("php Ch.php");
  ...
  height: 20%;
   ...
   <body style="text-align:center;">
		<div  class="Hlavicka" >
                ...
                <div class="box">
                        <div class="login">
                                <button id="btnfun1" name="tlc" onClick='location.href="?button1=1"'>Veľkoobchod</button>
                                <button id="btnfun2" name="tlc" onClick='location.href="?button2=1"'>Chcem nakúpiť ale nemám objednávku</button>
                        </div>
                        <div class="login">
                                <button id="btnfun3" name="tlc" onClick='location.href="?button3=1"'>Mám dohodnutý termín/osobný odber</button>
                                <button id="btnfun4" name="tlc" onClick='location.href="?button4=1"'>Reklamácia</button>
                        </div>
				</div>
	</body>
</html>
